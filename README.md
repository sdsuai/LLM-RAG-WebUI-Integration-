...
* For submission you must submit a pull request to this repo so that we have access to your username and get find your repo. **However, so others don't copy your work, make a private clone of the forked repo and send an invite to me (uamadasun@sdsu.edu) so I can gain access access.** In your ReadME,  make sure to provide your email address.
